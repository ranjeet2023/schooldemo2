<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-left">
        <a class="{!! request()->is('account/report/cash-book')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('account.report.cash-book') }}"><i class="fa fa-rupee" aria-hidden="true"></i>&nbsp;Cash Book</a>
