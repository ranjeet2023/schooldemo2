<div class="clearfix hidden-print ">
    <div class="easy-link-menu align-right">
        ...
        <a class="{!! request()->is('info/smsemail*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('info.smsemail') }}"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;Sms/Email/Whatsapp</a>
