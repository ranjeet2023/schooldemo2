<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-left">
        ...
        <a class="{!! request()->is('setting/email')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.whatsapp') }}"><i class="fa fa-whatsapp" aria-hidden="true"></i>&nbsp;Whatsapp Setting</a>
        ...
        <a class="{!! request()->is('setting/payment-gateway')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.payment-gateway') }}"><i class="fa fa-rupee" aria-hidden="true"></i>&nbsp;Payment Gateway</a>
